...
const FOOTER_I18N = {
  en: {
    role: 'AI Infrastructure Engineer · Distributed Systems · Voice AI',
    bio: '25 years building carrier-grade systems. From telecom infrastructure to production AI voice platforms.',
  ...
  return (
    <footer className="mt-16 pt-8 border-t border-border">
      <div className="flex items-start gap-3 mb-6">
        ...
        />
        <div>
          <p className="font-medium text-foreground">Rosen Velikov</p>
      ...
      <div className="flex gap-3 mb-8">
        <a href="https://linkedin.com/in/rosenvelikov" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#0A66C2]/10 border border-[#0A66C2]/20 text-sm font-medium text-[#0A66C2] hover:bg-[#0A66C2]/20 transition-colors">
        ...
        <a href="https://github.com/djok" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-card border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:border-primary/30 transition-colors">
      ...
      <div className="flex items-center gap-3 text-xs text-muted-foreground">
        <span>&copy; {new Date().getFullYear()} Rosen Velikov. {f.copyright}</span>
